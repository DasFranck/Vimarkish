...
C'est un peu moins le cas désormais, suffisamment pour que je puisse prétendre écrire un blog avec du contenu.  
...
Le blog est déployé automatiquement grâce à des webhooks que je vous expliquerai dans un prochain article.  
